          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>Explore my diverse portfolio showcasing innovative projects in web development, design,and highlighting creativity, technical expertise, and problem-solving skills.</p>
